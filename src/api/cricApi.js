...
const RAPIDAPI_KEY = ''; //to get this go to RapidAPI and Sign in then go to API hub. 
//then https://rapidapi.com/cricketapilive/api/cricbuzz-cricket GO TO THIS WEBSITE AND COPY AND PASTE THE KEY HERE
